    ...
    do {
        ...
        switch (opcao) {
            case 1:
                ...
                break;
            case 2:
                printf("Funcionalidade de remoção para árvore 2-3-4 não implementada.\n\n");
                break;
            case 3:
                printf("\n--- Árvore 2-3-4 Atual ---\n");
                imprimeArvore234(arv234);
                ...
                break;
            case 4:
                printf("\nConvertendo a árvore 2-3-4 em Rubro-Negra...\n");
...
// A função do menu da Árvore Rubro-Negra (definida apenas uma vez)
void menuArvoreRB(rb* arvRB) {
    int opcao, valor;
    noRB* novoNo = NULL;
